...
/**
 * @description Http相关辅助类
 * @date 2015年8月25日 上午9:40:16
 * @version 1.0
 * @Company Buzzlysoft
 * @author Jerry Tan
...
public class HttpUtils {
	...
	private static Handler mHandler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			if ("".equals(mMsg)) {
				new MyAlertDialog(mContext, "网络错误").show();
			} else {
				new MyAlertDialog(mContext, mMsg).show();
			}
		};
	};
	...
	public static void doGetAsyn(Context context, final String urlStr,
			final CallBack callBack, String msg) {

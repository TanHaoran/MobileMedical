...
public class ABViewUtil {
	...
	public static int getViewMeasuredHeight(View view) {
		// int height = com.jerry.roundindicator.view.getMeasuredHeight();
		// if(0 < height){
		// return height;
		// }
	...
	public static int getViewMeasuredWidth(View view) {
		// int width = com.jerry.roundindicator.view.getMeasuredWidth();
		// if(0 < width){
		// return width;
		// }
		calcViewMeasure(view);
	...
	public static void calcViewMeasure(View view) {
		...
		// int height =
		// View.MeasureSpec.makeMeasureSpec(0,View.MeasureSpec.UNSPECIFIED);
		// com.jerry.roundindicator.view.measure(width,height);
	...
	public static ColorStateList createColorStateList(int normal, int pressed,
			int focused, int checked, int unable) {
